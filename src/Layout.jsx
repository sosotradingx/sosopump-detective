...
import {
  ...
  LayoutGrid, BarChart2, FlaskConical, Zap, Key, Crown, LogOut, Lock, Bell, Radar, Hexagon
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { name: "Harmonic PT", icon: Hexagon, page: "HarmonicPaperTrading" },
  { name: "Bot Status", icon: Radar, page: "bot-monitor" },
...
const PRO_PAGES = ["PaperTrading", "HarmonicPaperTrading", "TradingDashboard", "LiveTrading", "ApiSettings"];
